          ...
          <tbody className="divide-y divide-slate-100">
            {tableFilteredData.map((row) => (
              <tr key={row.id} className="hover:bg-slate-50 transition-colors group">
                <td className="px-4 py-3 text-sm font-medium text-slate-700 whitespace-nowrap">{row.nrc}</td>
                <td className="px-4 py-3 text-sm text-slate-600 font-semibold">{row.courseName}</td>
                <td className="px-4 py-3 text-sm text-slate-500">{row.block}</td>
                <td className="px-4 py-3 text-sm text-slate-500">{row.instructor}</td>
                <td className="px-4 py-3 text-sm text-slate-500">{row.building} - {row.room}</td>
